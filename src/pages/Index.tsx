...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A1A2E] via-[#16213E] to-[#0F3460]">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-[#1A1A2E]/90 backdrop-blur-md border-b border-red-500/20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <Icon name="Gamepad2" size={28} className="text-red-500" />
              <span className="text-xl font-bold text-white">REDUXGAMEDEV</span>
            </div>
            <div className="hidden md:flex space-x-8">
              <a href="#home" className="text-white hover:text-red-500 transition-colors story-link">Главная</a>
              <a href="#about" className="text-white hover:text-red-500 transition-colors story-link">О нас</a>
              <a href="#team" className="text-white hover:text-red-500 transition-colors story-link">Команда</a>
              <a href="#games" className="text-white hover:text-red-500 transition-colors story-link">Игры</a>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{animationDelay: '0.4s'}}>
              <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 text-lg hover-scale">
                <Icon name="Play" size={20} className="mr-2" />
                Наши игры
              </Button>
              <Button size="lg" variant="outline" className="border-red-500 text-red-500 hover:bg-red-600 hover:text-white px-8 py-4 text-lg">
      ...
      <section id="about" className="py-24 px-6 lg:px-8 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white/10 border-red-500/20 hover-scale">
              <CardContent className="p-8 text-center">
                <Icon name="Trophy" size={48} className="text-red-500 mx-auto mb-4" />
            ...
            <Card className="bg-white/10 border-red-500/20 hover-scale">
              <CardContent className="p-8 text-center">
                <Icon name="Code" size={48} className="text-red-500 mx-auto mb-4" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            {[
              ...
              <Card key={index} className="bg-white/10 border-red-500/20 hover-scale">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <Card key={index} className="bg-white/10 border-red-500/20 hover-scale group cursor-pointer">
                <CardContent className="p-6">
                  <div className="aspect-video bg-gradient-to-br from-red-600/20 to-[#1A1A2E]/20 rounded-lg mb-4 flex items-center justify-center">
                    <Icon name="Play" size={32} className="text-red-500 group-hover:scale-110 transition-transform" />
                  </div>
                  <h3 className="text-lg font-bold text-white mb-2">{game.title}</h3>
                  <p className="text-gray-300 text-sm mb-3">{game.genre}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-red-500 text-xs font-semibold bg-red-600/20 px-2 py-1 rounded">
                      {game.status}
                    </span>
      ...
      {/* Footer */}
      <footer className="py-12 px-6 lg:px-8 bg-[#1A1A2E] border-t border-red-500/20">
